...
export default function StatutoryInstruments() {
  ...
  const loadDocuments = async () => {
    ...
    try {
      const data = await fetchDocuments(
        {
          category: "Statutory Instruments",
          subcategory: filters.year
            ? `Statutory Instruments ${filters.year}`
            : null,
        },
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
       <SEO
        title={filters.year ? `Statutory Instruments ${filters.year} | Educite Virtual Library` : "Statutory Instruments | Educite Virtual Library"}
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="mt-2 text-lg text-gray-600">
              Browse and search through recent Statutory Instruments
            </p>
          </div>
