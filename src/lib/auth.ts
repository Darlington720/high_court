...
export async function createTestAccounts() {
  const accounts = [
    { email: 'admin@test.com', password: 'Test123#', role: 'admin', tier: 'platinum' },
    { email: 'gold@test.com', password: 'Test123#', role: 'subscriber', tier: 'gold' },
    { email: 'silver@test.com', password: 'Test123#', role: 'subscriber', tier: 'silver' },
    { email: 'bronze@test.com', password: 'Test123#', role: 'subscriber', tier: 'bronze' },
    { email: 'guest1@test.com', password: 'Test123#', role: 'guest', tier: null },
    { email: 'guest2@test.com', password: 'Test123#', role: 'guest', tier: null }
  ];
